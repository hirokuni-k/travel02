...
def decide_quentity(chosen_product)
...
def caluculate_charges(chosen_product, quantity_of_product)
...
quantity_of_product = decide_quentity(chosen_product)
caluculate_charges(chosen_product, quantity_of_product)
